...
public class Ff {
    ...
    public static class SearchParams {
        ...
        /**
         * Ruft den Wert der followSearch-Eigenschaft ab.
         * 
         */
        public int getFollowSearch() {
            return followSearch;
        }

        /**
         * Legt den Wert der followSearch-Eigenschaft fest.
         * 
         */
        public void setFollowSearch(int value) {
            this.followSearch = value;
        }
